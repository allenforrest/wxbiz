...
class WXBizInfo(MocBase):
    ...
    __SQLITE_SELECT_SQL__ = 'select [moid], [biz_id], [access_token], [login_user], [login_pwd] from tbl_WXBizInfo' 
    __ORACLE_SELECT_SQL__ = 'select "moid", "biz_id", "access_token", "login_user", "login_pwd" from tbl_WXBizInfo' 
    __SQLITE_INSERT_SQL__ = 'insert into tbl_WXBizInfo ([moid], [biz_id], [access_token], [login_user], [login_pwd]) values(?1, ?2, ?3, ?4, ?5)' 
    __ORACLE_INSERT_SQL__ = 'insert into tbl_WXBizInfo ("moid", "biz_id", "access_token", "login_user", "login_pwd") values(:1, :2, :3, :4, :5)' 
    
    __SQLITE_UPDATE_SQL__ = 'update tbl_WXBizInfo set [access_token]=?1, [login_user]=?2, [login_pwd]=?3 where [moid]=?4' 
    __ORACLE_UPDATE_SQL__ = 'update tbl_WXBizInfo set "access_token"=:1, "login_user"=:2, "login_pwd"=:3 where "moid"=:4' 
    ...
    def get_attr_names(cls): 
        return ('biz_id',), ('access_token', 'login_user', 'login_pwd')
